...
class YW_ETFMM_SZSJ_343_D(xtp_test_case):

    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_ETFMM_SZSJ_343_D')
        clear_data_and_restart_sz()
        Api.trade.Logout()
        Api.trade.Login()

    def test_YW_ETFMM_SZSJ_343_D(self):
        ...
        stkparm = QueryStkPriceQty('157134', '2', '14', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
