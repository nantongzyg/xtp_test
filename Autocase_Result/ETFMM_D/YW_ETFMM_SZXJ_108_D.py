...
class YW_ETFMM_SZXJ_108_D(xtp_test_case):
    # YW_ETFMM_SZXJ_108_D
    def test_YW_ETFMM_SZXJ_108_D(self):
        ...
        stkparm = QueryStkPriceQty('157166', '2', '14', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
        ...
        # T+0买
        title = '深圳Ａ股股票限价卖出交易日限价委托（未持有证券代码）-T+0买'
        ...
        self.assertEqual(rs['用例测试结果'], True)
        # T+0卖
        title = '深圳Ａ股股票限价卖出交易日限价委托（未持有证券代码）-T+0卖'
        logger.warning(title)
