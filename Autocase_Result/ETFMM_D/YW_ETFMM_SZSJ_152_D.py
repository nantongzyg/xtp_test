...
class YW_ETFMM_SZSJ_152_D(xtp_test_case):
    # YW_ETFMM_SZSJ_152_D
    def test_YW_ETFMM_SZSJ_152_D(self):
        title = '交易日五档即成转撤销-T+0买→T+0卖（已持有证券代码）'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('157208', '2', '14', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
