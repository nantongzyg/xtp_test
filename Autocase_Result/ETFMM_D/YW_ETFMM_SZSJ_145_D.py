...
class YW_ETFMM_SZSJ_145_D(xtp_test_case):
    # YW_ETFMM_SZSJ_145_D
    def test_YW_ETFMM_SZSJ_145_D(self):
        title = '交易日五档即成转撤销卖-先卖零头股再卖整数股'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('157201', '2', '14', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
