...
class YW_ETFMM_SHSJ_139_D(xtp_test_case):
    # YW_ETFMM_SHSJ_139_D
    def test_YW_ETFMM_SHSJ_139_D(self):
        title = '沪A五档即成转撤销卖（卖出数量=可用股份数+100）'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('514015', '1', '14', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
