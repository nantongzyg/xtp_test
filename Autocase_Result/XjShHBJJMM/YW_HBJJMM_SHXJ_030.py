...
class YW_HBJJMM_SHXJ_030(xtp_test_case):

    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_HBJJMM_SHXJ_030')
        clear_data_and_restart_sh()
        Api.trade.Logout()
        Api.trade.Login()

    def test_YW_HBJJMM_SHXJ_030(self):
        ...
        stkparm = QueryStkPriceQty('511807', '1', '111', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
