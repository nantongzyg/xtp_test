...
class YW_HBJJMM_SHXJ_081(xtp_test_case):
    # YW_HBJJMM_SHXJ_081
    def test_YW_HBJJMM_SHXJ_081(self):
        title = '默认3：订单报价超过涨跌幅限制-沪A限价卖><跌停价（跌停价-0.002）'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('511809', '1', '111', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
