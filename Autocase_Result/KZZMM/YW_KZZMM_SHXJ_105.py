...
class YW_KZZMM_SHXJ_105(xtp_test_case):
    # YW_KZZMM_SHXJ_105
    def test_YW_KZZMM_SHXJ_105(self):
        ...
        stkparm = QueryStkPriceQty('110019', '1', '8', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
        ...
        # T+0买
        title = '上海Ａ股可转债交易日限价委托（已持有证券代码）-T+0买'
        ...
        self.assertEqual(rs['用例测试结果'], True)
        # T+0卖
        title = '上海Ａ股可转债交易日限价委托（已持有证券代码）-T+0卖'
        logger.warning(title)
