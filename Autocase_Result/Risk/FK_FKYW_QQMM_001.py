...
class FK_FKYW_QQMM_001(xtp_test_case):
    ...
    def test_FK_FKYW_QQMM_001(self):
        ...
        # stkparm = QueryStkPriceQty('11002290','1','30','1','0','B',case_goal['期望状态'],Api)
        # # 如果下单参数获取失败，则用例失败
        ...
        count = 1
        max_count = 10000
        filename1 = 'FK_FKYW_QQMM_001_order1'
        filename2 = 'FK_FKYW_QQMM_001_order2'
