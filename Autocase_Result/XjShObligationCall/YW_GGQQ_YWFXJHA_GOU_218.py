...
class YW_GGQQ_YWFXJHA_GOU_218(xtp_test_case):
    # YW_GGQQ_YWFXJHA_GOU_218

    def test_YW_GGQQ_YWFXJHA_GOU_218(self):
        title='买平（义务方平仓）：FOK限价全成或撤销-错误的价格（价格巨大）'
        #定义当前测试用例的期待值
