...
class YW_GGQQ_YWFXJHA_GOU_190(xtp_test_case):
    # YW_GGQQ_YWFXJHA_GOU_190

    def test_YW_GGQQ_YWFXJHA_GOU_190(self):
        title='沪A买平（义务方平仓）：FOK限价全成或撤销-OMS拒单（跌停价-0.0002）'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('20002443', '1', '*', '1', '0', 'C', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
