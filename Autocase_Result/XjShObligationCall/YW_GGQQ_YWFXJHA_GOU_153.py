...
class YW_GGQQ_YWFXJHA_GOU_153(xtp_test_case):
    # YW_GGQQ_YWFXJHA_GOU_153

    def test_YW_GGQQ_YWFXJHA_GOU_153(self):
        title='沪A卖开（义务方开仓）：FOK限价全成或撤销-OMS拒单（涨停价+0.0002）'
        #定义当前测试用例的期待值
