...
class YW_GGQQ_YWFXJHA_GOU_148(xtp_test_case):
    # YW_GGQQ_YWFXJHA_GOU_148

    def test_YW_GGQQ_YWFXJHA_GOU_148(self):
        title='卖开（义务方开仓，有昨仓）：FOK限价全成或撤销-已成（费用=min）'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('10001211', '1', '*', '1', '0', 'C', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
