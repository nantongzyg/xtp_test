...
class YW_PGJK_SHKCB_QXJY_001(xtp_test_case):
    def setUp(self):
    ...
    # YW_PGJK_SHKCB_QXJY_001
    def test_YW_PGJK_SHKCB_QXJY_001(self):
        title = 'OMS初始化—可选权限—Secuinfo表，沪A证券账号无买入科创板股票权限（一级市场交易权限验证）'
        # 定义当前测试用例的期待值
        ...
        self.assertEqual(rs['用例测试结果'], True) # 307
