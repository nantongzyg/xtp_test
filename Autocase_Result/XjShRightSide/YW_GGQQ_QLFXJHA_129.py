...
class YW_GGQQ_QLFXJHA_129(xtp_test_case):
    # YW_GGQQ_QLFXJHA_129

    def test_YW_GGQQ_QLFXJHA_129(self):
        title='买开（权利方开仓）：FOK限价全成或撤销-错误的市场'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('999999', '1', '*', '1', '0', '*', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
