...
class YW_GGQQ_QLFXJHA_151(xtp_test_case):
    # YW_GGQQ_QLFXJHA_151

    def test_YW_GGQQ_QLFXJHA_151(self):
        title='卖平（权利方平仓）：FOK限价全成或撤销-全撤再撤单（OMS）'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('10001025', '1', '*', '1', '0', '*', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
