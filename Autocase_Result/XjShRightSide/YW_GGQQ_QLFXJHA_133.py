...
class YW_GGQQ_QLFXJHA_133(xtp_test_case):
    # YW_GGQQ_QLFXJHA_133

    def test_YW_GGQQ_QLFXJHA_133(self):
        title='买开（权利方开仓）：FOK限价全成或撤销-错误的数量（大于限价最大量）'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('10001167', '1', '*', '1', '0', '*', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
