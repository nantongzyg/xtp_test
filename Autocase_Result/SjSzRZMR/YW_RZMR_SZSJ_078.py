...
class YW_RZMR_SZSJ_078(xtp_test_case):
    # YW_RZMR_SZSJ_078 YW_RZMR_SZSJ_078 YW_RZMR_SZSJ_078 YW_RZMR_SZSJ_078
    def test_YW_RZMR_SZSJ_078(self):
        title='全部成交或撤销买——不存在的证券代码'
        #定义当前测试用例的期待值
