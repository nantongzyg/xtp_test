...
class YW_RZMR_SZSJ_087(xtp_test_case):
    # YW_RZMR_SZSJ_087 YW_RZMR_SZSJ_087 YW_RZMR_SZSJ_087 YW_RZMR_SZSJ_087
    def test_YW_RZMR_SZSJ_087(self):
        title = '全部成交或撤销买——金额溢出（总金额>10亿）'
        # 定义当前测试用例的期待值
