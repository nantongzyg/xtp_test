...
class YW_RZMR_SZSJ_079(xtp_test_case):
    # YW_RZMR_SZSJ_079 YW_RZMR_SZSJ_079 YW_RZMR_SZSJ_079 YW_RZMR_SZSJ_079
    def test_YW_RZMR_SZSJ_079(self):
        title = '全部成交或撤销买——错误的市场'
        # 定义当前测试用例的期待值
