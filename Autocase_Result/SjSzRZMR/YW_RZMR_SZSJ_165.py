...
class YW_RZMR_SZSJ_165(xtp_test_case):
    # YW_RZMR_SZSJ_165 YW_RZMR_SZSJ_165
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_credit_asset('YW_RZMR_SZSJ_165')
        sql_transfer.transfer_credit_cash_fund_asset('YW_RZMR_SZSJ_165')
        clear_data_and_restart_sz()
        Api.trade.Logout()
        Api.trade.Login()

    def test_YW_RZMR_SZSJ_165(self):
        title = '全部成交或撤销买--下单金额+手续费<=融资头寸'
        # 定义当前测试用例的期待值
