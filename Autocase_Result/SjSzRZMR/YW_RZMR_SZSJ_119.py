...
class YW_RZMR_SZSJ_119(xtp_test_case):
    # YW_RZMR_SZSJ_119 YW_RZMR_SZSJ_119 YW_RZMR_SZSJ_119 YW_RZMR_SZSJ_119
    def test_YW_RZMR_SZSJ_119(self):
        title = '本方最优买——错误的数量(数量>100万)'
        # 定义当前测试用例的期待值
