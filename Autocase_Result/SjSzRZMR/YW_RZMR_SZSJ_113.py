...
class YW_RZMR_SZSJ_113(xtp_test_case):
    # YW_RZMR_SZSJ_113 YW_RZMR_SZSJ_113 YW_RZMR_SZSJ_113 YW_RZMR_SZSJ_113
    def test_YW_RZMR_SZSJ_113(self):
        title='本方最优买——不存在的证券代码'
        #定义当前测试用例的期待值
