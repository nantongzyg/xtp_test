...
class YW_RZMR_SZSJ_023(xtp_test_case):
    # YW_RZMR_SZSJ_023 YW_RZMR_SZSJ_023 YW_RZMR_SZSJ_023 YW_RZMR_SZSJ_023
    def test_YW_RZMR_SZSJ_023(self):
        title = '即成剩撤买-错误的价格（价格<0）'
        # 定义当前测试用例的期待值
