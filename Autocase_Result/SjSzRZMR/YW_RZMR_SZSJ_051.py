...
class YW_RZMR_SZSJ_051(xtp_test_case):
    # YW_RZMR_SZSJ_051 YW_RZMR_SZSJ_051 YW_RZMR_SZSJ_051 YW_RZMR_SZSJ_051
    def test_YW_RZMR_SZSJ_051(self):
        title='五档即成转撤销买——不存在的证券代码'
        #定义当前测试用例的期待值
