...
class YW_RZMR_SZSJ_151(xtp_test_case):
    # YW_RZMR_SZSJ_151 YW_RZMR_SZSJ_151 YW_RZMR_SZSJ_151 YW_RZMR_SZSJ_151
    def test_YW_RZMR_SZSJ_151(self):
        title = '对方最优转限价买——错误的数量(数量<0)'
        # 定义当前测试用例的期待值
