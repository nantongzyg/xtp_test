...
class YW_RZMR_SZSJ_080(xtp_test_case):
    # YW_RZMR_SZSJ_080 YW_RZMR_SZSJ_080 YW_RZMR_SZSJ_080 YW_RZMR_SZSJ_080
    def test_YW_RZMR_SZSJ_080(self):
        title = '全部成交或撤销买——错误的价格(价格<0)'
        # 定义当前测试用例的期待值
