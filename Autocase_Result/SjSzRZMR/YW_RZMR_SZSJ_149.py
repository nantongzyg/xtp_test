...
class YW_RZMR_SZSJ_149(xtp_test_case):
    # YW_RZMR_SZSJ_149 YW_RZMR_SZSJ_149 YW_RZMR_SZSJ_149 YW_RZMR_SZSJ_149
    def test_YW_RZMR_SZSJ_149(self):
        title = '对方最优转限价买——错误的价格(价格<0)'
        # 定义当前测试用例的期待值
