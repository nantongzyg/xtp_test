...
class YW_RZMR_SZSJ_122(xtp_test_case):
    # YW_RZMR_SZSJ_122 YW_RZMR_SZSJ_122 YW_RZMR_SZSJ_122 YW_RZMR_SZSJ_122
    def test_YW_RZMR_SZSJ_122(self):
        title = '本方最优买——金额溢出（总金额>10亿）'
        # 定义当前测试用例的期待值
