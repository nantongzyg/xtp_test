...
class YW_RZMR_SZSJ_117(xtp_test_case):
    # YW_RZMR_SZSJ_117 YW_RZMR_SZSJ_117 YW_RZMR_SZSJ_117 YW_RZMR_SZSJ_117
    def test_YW_RZMR_SZSJ_117(self):
        title = '本方最优买——错误的数量(数量<0)'
        # 定义当前测试用例的期待值
