...
class YW_RZMR_SZSJ_061(xtp_test_case):
    # YW_RZMR_SZSJ_061 YW_RZMR_SZSJ_061 YW_RZMR_SZSJ_061 YW_RZMR_SZSJ_061
    def test_YW_RZMR_SZSJ_061(self):
        title = '五档即成转撤销买——金额溢出（总金额>10亿）'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('003280', '2', '0', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
