...
class YW_RZMR_SZSJ_115(xtp_test_case):
    # YW_RZMR_SZSJ_115 YW_RZMR_SZSJ_115 YW_RZMR_SZSJ_115 YW_RZMR_SZSJ_115
    def test_YW_RZMR_SZSJ_115(self):
        title = '本方最优买——错误的价格(价格<0)'
        # 定义当前测试用例的期待值
