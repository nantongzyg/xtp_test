...
class YW_RZMR_SZSJ_021(xtp_test_case):
    # YW_RZMR_SZSJ_021 YW_RZMR_SZSJ_021 YW_RZMR_SZSJ_021 YW_RZMR_SZSJ_021
    def test_YW_RZMR_SZSJ_021(self):
        title='即成剩撤买-不存在的证券代码'
        #定义当前测试用例的期待值
