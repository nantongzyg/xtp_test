...
class YW_RZMR_SZSJ_030(xtp_test_case):
    # YW_RZMR_SZSJ_030 YW_RZMR_SZSJ_030 YW_RZMR_SZSJ_030 YW_RZMR_SZSJ_030
    def test_YW_RZMR_SZSJ_030(self):
        title = '即成剩撤买-金额溢出（总金额>10亿）'
        # 定义当前测试用例的期待值
