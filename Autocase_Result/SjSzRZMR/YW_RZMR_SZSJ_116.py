...
class YW_RZMR_SZSJ_116(xtp_test_case):
    # YW_RZMR_SZSJ_116 YW_RZMR_SZSJ_116 YW_RZMR_SZSJ_116 YW_RZMR_SZSJ_116
    def test_YW_RZMR_SZSJ_116(self):
        title = '本方最优买——错误的价格(价格10亿)'
        # 定义当前测试用例的期待值
