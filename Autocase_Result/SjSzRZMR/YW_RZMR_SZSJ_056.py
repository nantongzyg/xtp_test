...
class YW_RZMR_SZSJ_056(xtp_test_case):
    # YW_RZMR_SZSJ_056 YW_RZMR_SZSJ_056 YW_RZMR_SZSJ_056 YW_RZMR_SZSJ_056
    def test_YW_RZMR_SZSJ_056(self):
        title = '五档即成转撤销买——错误的数量(数量<0)'
        # 定义当前测试用例的期待值
