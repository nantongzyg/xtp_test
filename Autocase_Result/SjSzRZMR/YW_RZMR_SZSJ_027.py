...
class YW_RZMR_SZSJ_027(xtp_test_case):
    # YW_RZMR_SZSJ_027 YW_RZMR_SZSJ_027 YW_RZMR_SZSJ_027 YW_RZMR_SZSJ_027
    def test_YW_RZMR_SZSJ_027(self):
        title = '即成剩撤买-单笔最大申报数量（=1000000）'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('003286', '2', '0', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
