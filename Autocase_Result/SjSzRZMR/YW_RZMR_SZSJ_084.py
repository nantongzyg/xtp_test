...
class YW_RZMR_SZSJ_084(xtp_test_case):
    # YW_RZMR_SZSJ_084 YW_RZMR_SZSJ_084 YW_RZMR_SZSJ_084 YW_RZMR_SZSJ_084
    def test_YW_RZMR_SZSJ_084(self):
        title = '全部成交或撤销买——错误的数量(数量>100万)'
        # 定义当前测试用例的期待值
