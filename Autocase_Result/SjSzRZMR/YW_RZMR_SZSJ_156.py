...
class YW_RZMR_SZSJ_156(xtp_test_case):
    # YW_RZMR_SZSJ_156 YW_RZMR_SZSJ_156 YW_RZMR_SZSJ_156 YW_RZMR_SZSJ_156
    def test_YW_RZMR_SZSJ_156(self):
        title = '对方最优转限价买——金额溢出（总金额>10亿）'
        # 定义当前测试用例的期待值
