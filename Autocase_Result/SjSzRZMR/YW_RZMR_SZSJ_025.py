...
class YW_RZMR_SZSJ_025(xtp_test_case):
    # YW_RZMR_SZSJ_025 YW_RZMR_SZSJ_025 YW_RZMR_SZSJ_025 YW_RZMR_SZSJ_025
    def test_YW_RZMR_SZSJ_025(self):
        title = '即成剩撤买-错误的数量（数量=0）'
        # 定义当前测试用例的期待值
