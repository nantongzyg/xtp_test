...
class YW_RZMR_SZSJ_058(xtp_test_case):
    # YW_RZMR_SZSJ_058 YW_RZMR_SZSJ_058 YW_RZMR_SZSJ_058 YW_RZMR_SZSJ_058
    def test_YW_RZMR_SZSJ_058(self):
        title = '五档即成转撤销买——错误的数量(数量>100万)'
        # 定义当前测试用例的期待值
