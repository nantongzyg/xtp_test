...
class YW_RZMR_SZSJ_129(xtp_test_case):
    # YW_RZMR_SZSJ_129 YW_RZMR_SZSJ_129 YW_RZMR_SZSJ_129 YW_RZMR_SZSJ_129
    def test_YW_RZMR_SZSJ_129(self):
        ...
        stkparm = QueryStkPriceQty('003255', '2', '0', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
