...
class YW_RZMR_SZSJ_081(xtp_test_case):
    # YW_RZMR_SZSJ_081 YW_RZMR_SZSJ_081 YW_RZMR_SZSJ_081 YW_RZMR_SZSJ_081
    def test_YW_RZMR_SZSJ_081(self):
        title = '全部成交或撤销买——错误的价格(价格10亿)'
        # 定义当前测试用例的期待值
