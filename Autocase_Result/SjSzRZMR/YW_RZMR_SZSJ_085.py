...
class YW_RZMR_SZSJ_085(xtp_test_case):
    # YW_RZMR_SZSJ_085 YW_RZMR_SZSJ_085 YW_RZMR_SZSJ_085 YW_RZMR_SZSJ_085
    def test_YW_RZMR_SZSJ_085(self):
        title = '全部成交或撤销买——错误的价格条件'
        # 定义当前测试用例的期待值
