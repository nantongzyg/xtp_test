...
class YW_RZMR_SZSJ_059(xtp_test_case):
    # YW_RZMR_SZSJ_059 YW_RZMR_SZSJ_059 YW_RZMR_SZSJ_059 YW_RZMR_SZSJ_059
    def test_YW_RZMR_SZSJ_059(self):
        title = '五档即成转撤销买——错误的价格条件'
        # 定义当前测试用例的期待值
        ...
        case_goal = {
            '期望状态': '废单',
            'errorID': 11000109,
            'errorMSG': queryOrderErrorMsg(11000109),
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
        ...
        if stkparm['返回结果'] is False:
            ...
            wt_reqs = {
                ...
                'price_type': Api.const.XTP_PRICE_TYPE['XTP_PRICE_TYPE_UNKNOWN'],
                'price': stkparm['涨停价'],
                'quantity': 200
            }
