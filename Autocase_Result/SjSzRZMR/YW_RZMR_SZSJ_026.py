...
class YW_RZMR_SZSJ_026(xtp_test_case):
    # YW_RZMR_SZSJ_026 YW_RZMR_SZSJ_026 YW_RZMR_SZSJ_026 YW_RZMR_SZSJ_026
    def test_YW_RZMR_SZSJ_026(self):
        title = '即成剩撤买-错误的数量（>100万）'
        # 定义当前测试用例的期待值
