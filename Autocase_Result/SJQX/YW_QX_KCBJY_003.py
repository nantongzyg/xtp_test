...
class YW_QX_KCBJY_003(xtp_test_case):
    # YW_QX_KCBJY_003
    def test_YW_QX_KCBJY_003(self):
        title = 'OMS初始化—可选权限—Fundinfo&Secuinfo表，无市价委托权限--买科创板'
        # 定义当前测试用例的期待值
        ...
        case_goal = {
            '期望状态': '废单',
            'errorID': 11000551,
            'errorMSG': queryOrderErrorMsg(11000551),
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
        ...
        if stkparm['返回结果'] is False:
            ...
            self.assertEqual(rs['用例测试结果'], True) # 402 
