...
class YW_GGQQ_YWFXJHA_GU_172(xtp_test_case):
    # YW_GGQQ_YWFXJHA_GU_172

    def test_YW_GGQQ_YWFXJHA_GU_172(self):
        ...
        stkparm = QueryStkPriceQty('999999', '1', '*', '1', '0', 'P', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
