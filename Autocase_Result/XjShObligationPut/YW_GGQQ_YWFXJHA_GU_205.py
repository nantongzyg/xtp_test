...
class YW_GGQQ_YWFXJHA_GU_205(xtp_test_case):

    def setUp(self):
        sql_transfer = Opt_SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_GGQQ_YWFXJHA_GU_205')
        clear_data_and_restart_sh()
        Api.trade.Logout()
        Api.trade.Login()

    def test_YW_GGQQ_YWFXJHA_GU_205(self):
        ...
        stkparm = QueryStkPriceQty('11002399', '1', '*', '1', '0', 'P', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
