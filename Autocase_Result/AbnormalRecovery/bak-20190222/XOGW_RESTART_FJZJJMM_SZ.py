...
class XOGW_RESTART_FJZJJMM_SZ(unittest.TestCase):

    def test_XOGW_RESTART_FJZJJMM_SZ(self):

        title = '异常恢复：重启报盘-分级子基金买卖-深圳'
        logger.warning(title)
        # 定义委托参数信息------------------------------------------
        # 参数：证券代码、市场、证券类型、证券状态、交易状态、买卖方向（Ｂ买Ｓ卖）、期望状态、Api
        stkparm = QueryStkPriceQty('150008', '2', '24', '2', '0', 'B', '全成',
                                   tradeApi)
        # 如果下单参数获取失败，则用例失败
