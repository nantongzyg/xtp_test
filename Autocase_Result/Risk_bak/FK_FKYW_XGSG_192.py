...
class FK_FKYW_XGSG_192(xtp_test_case):
    ...
    def test_FK_FKYW_XGSG_192(self):
        ...
        count = 1
        max_count = 5000
        filename1 = 'FK_FKYW_XGSG_192_order1'
        filename2 = 'FK_FKYW_XGSG_192_order2'
        insert_orders(count, max_count, Api, case_goal, wt_reqs, filename1)

        time.sleep(56)
        max_count = 300
        wt_reqs['quantity'] = 1000
        ...
        # 校验订单是否正确触发风控
        rule43_check2(filename1, filename2)
