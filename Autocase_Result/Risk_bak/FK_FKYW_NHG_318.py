...
class FK_FKYW_NHG_318(xtp_test_case):
    ...
    def test_FK_FKYW_NHG_318(self):
        ...
        stkparm = QueryStkPriceQty('131811', '2', '12', '2', '0', 'S',
                                   case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
        if stkparm['返回结果'] == False:
            ...
            count = 1
            max_count = 5000
            filename1 = 'FK_FKYW_NHG_318_order1'
            filename2 = 'FK_FKYW_NHG_318_order2'
