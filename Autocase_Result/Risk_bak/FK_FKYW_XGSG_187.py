...
class FK_FKYW_XGSG_187(xtp_test_case):
    ...
    def test_FK_FKYW_XGSG_187(self):
        ...
        count = 1
        max_count = 20
        filename1 = 'FK_FKYW_XGSG_187_order1'
        filename2 = 'FK_FKYW_XGSG_187_order2'
        insert_orders_sleep(count, max_count, Api, case_goal, wt_reqs, filename1)

        max_count = 1
        wt_reqs['ticker'] = '002859'
        insert_orders_sleep(count, max_count, Api, case_goal, wt_reqs, filename1)

        time.sleep(60)
        max_count = 200
        wt_reqs['ticker'] = '002862'
        ...
        # 校验订单是否正确触发风控
        rule27_check_xgsg(filename1, filename2)
