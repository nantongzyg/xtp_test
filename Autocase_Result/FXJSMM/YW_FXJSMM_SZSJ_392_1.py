...
class YW_FXJSMM_SZSJ_392_1(xtp_test_case):
    # YW_FXJSMM_SZSJ_392_1
    def test_YW_FXJSMM_SZSJ_392_1(self):
        ...
        stkparm = QueryStkPriceQty('001086', '2', '0', '0', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
