...
class YW_FJZJJMM_SZSJ_073(xtp_test_case):
    # YW_FJZJJMM_SZSJ_073
    def test_YW_FJZJJMM_SZSJ_073(self):
        ...
        stkparm = QueryStkPriceQty('151185', '2', '24', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
