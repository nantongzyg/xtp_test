...
class YW_FJZJJMM_SZSJ_391(xtp_test_case):
    # YW_FJZJJMM_SZSJ_391
    def test_YW_FJZJJMM_SZSJ_391(self):
        title = '交易日对方最优转限价卖-T+0卖→T+0买'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('151265', '2', '24', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
