...
class YW_FJZJJMM_SZSJ_217(xtp_test_case):
    # YW_FJZJJMM_SZSJ_217
    def test_YW_FJZJJMM_SZSJ_217(self):
        title = '交易日全部成交或撤销卖-先卖零头股再卖整数股'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('151221', '2', '24', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
