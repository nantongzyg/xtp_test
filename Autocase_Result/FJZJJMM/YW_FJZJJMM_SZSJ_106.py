...
class YW_FJZJJMM_SZSJ_106(xtp_test_case):

    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_FJZJJMM_SZSJ_106')
        clear_data_and_restart_sz()
        Api.trade.Logout()
        Api.trade.Login()

    def test_YW_FJZJJMM_SZSJ_106(self):
        ...
        stkparm = QueryStkPriceQty('151107', '2', '24', '2', '0', 'B', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
