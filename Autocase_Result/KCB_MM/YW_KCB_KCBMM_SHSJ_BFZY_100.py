...
class YW_KCB_KCBMM_SHSJ_BFZY_100(xtp_test_case):
    # YW_KCB_KCBMM_SHSJ_BFZY_100
    def test_YW_KCB_KCBMM_SHSJ_BFZY_100(self):
        title = '上海Ａ股股票交易日本方最优卖——允许的保护价格下限(价格=0.01)'
        # 定义当前测试用例的期待值
