...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_139(xtp_test_case):
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_139')
    ...
    # 
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_139(self):
        ...
        stkparm = QueryStkPriceQty('688014', '1', '4', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
