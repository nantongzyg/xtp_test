...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_100(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_100
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_100(self):
