...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_137(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_137
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_137(self):
        title = '交易日五档即成转限价-T+0买→T+0卖（T-1日已持有证券代码688000）原有300,买300,再卖600'
        # 定义当前测试用例的期待值
