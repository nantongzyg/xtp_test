...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_070(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_070
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_070(self):
