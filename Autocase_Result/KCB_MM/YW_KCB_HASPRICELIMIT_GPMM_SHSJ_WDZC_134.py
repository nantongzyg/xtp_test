...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_134(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_134
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_134(self):
        title = '交易日五档即成转撤销卖-第一笔卖出大于200且含个股数量；第二笔卖出剩余小于200部分'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('688007', '1', '4', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
