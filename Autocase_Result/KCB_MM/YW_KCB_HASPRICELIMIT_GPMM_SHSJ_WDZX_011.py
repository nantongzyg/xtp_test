...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_011(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_011
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_011(self):
