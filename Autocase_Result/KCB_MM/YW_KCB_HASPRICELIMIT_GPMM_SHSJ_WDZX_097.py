...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_097(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_097
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_097(self):
