...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_021(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_021
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_021(self):
        title = '五档即成转限价买-全撤再撤单(OMS)'
        # 定义当前测试用例的期待值
