...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_056(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_056
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_056(self):
