...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_132(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_132
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_132(self):
        title = '交易日五档即成转限价卖-先卖不足200部分，再买200整数倍'
        # 定义当前测试用例的期待值
