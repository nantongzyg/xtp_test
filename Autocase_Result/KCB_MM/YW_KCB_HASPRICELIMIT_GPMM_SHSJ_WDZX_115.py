...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_115(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_115
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_115(self):
        title = '上海Ａ股股票交易日五档即成转限价卖——错误的数量(数量=0)'
        # 定义当前测试用例的期待值
