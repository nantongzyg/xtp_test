...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_141(xtp_test_case):
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_141')
    ...
    # 
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_141(self):
        title = '分笔成交-累积成交金额 < 累积成交费用'
        # 定义当前测试用例的期待值
