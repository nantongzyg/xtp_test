...
class YW_KCB_KCBMM_SHSJ_BFZY_132(xtp_test_case):
    # YW_KCB_KCBMM_SHSJ_BFZY_132
    def test_YW_KCB_KCBMM_SHSJ_BFZY_132(self):
        title = '交易日本方最优卖-第一笔卖出大于200且含个股数量；第二笔卖出剩余小于200部分'
        # 定义当前测试用例的期待值
