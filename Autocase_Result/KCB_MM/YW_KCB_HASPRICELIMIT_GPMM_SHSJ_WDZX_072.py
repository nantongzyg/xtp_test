...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_072(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_072
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_072(self):
        title = '五档即成转限价卖--部成'
        # 定义当前测试用例的期待值
