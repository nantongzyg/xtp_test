...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_135(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_135
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_135(self):
        title = '交易日五档即成转撤销-T+0卖→T+0买 卖全部300,再买300'
        # 定义当前测试用例的期待值
