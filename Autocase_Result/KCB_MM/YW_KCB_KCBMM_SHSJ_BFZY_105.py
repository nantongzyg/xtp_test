...
class YW_KCB_KCBMM_SHSJ_BFZY_105(xtp_test_case):
    # YW_KCB_KCBMM_SHSJ_BFZY_105
    def test_YW_KCB_KCBMM_SHSJ_BFZY_105(self):
        title='上海Ａ股股票交易日本方最优卖——输入的保护价格四舍五入后<保护价格上限(9999.974)'
        #定义当前测试用例的期待值
