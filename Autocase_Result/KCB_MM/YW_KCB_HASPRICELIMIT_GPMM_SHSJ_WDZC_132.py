...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_132(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_132
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_132(self):
        title = '交易日五档即成转撤销卖-先卖不足200部分，再买200整数倍'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('688005', '1', '4', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
        if stkparm['返回结果'] is False:
            ...
            #self.assertEqual(rs['用例测试结果'], True) # 216
