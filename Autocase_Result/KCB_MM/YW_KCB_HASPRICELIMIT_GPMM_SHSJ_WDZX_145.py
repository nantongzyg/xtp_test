...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_145(xtp_test_case):
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_xtp_default_fee_rate('YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_145')
        oms_restart()
        Api.trade.Logout()
        Api.trade.Login()
        pass
    ...
    # 
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_145(self):
