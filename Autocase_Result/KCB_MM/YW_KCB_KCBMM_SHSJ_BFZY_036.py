...
class YW_KCB_KCBMM_SHSJ_BFZY_036(xtp_test_case):
    # YW_KCB_KCBMM_SHSJ_BFZY_036
    def test_YW_KCB_KCBMM_SHSJ_BFZY_036(self):
        title = '上海Ａ股股票交易日本方最优买——允许的保护价格下限(价格=0.01)'
        # 定义当前测试用例的期待值
