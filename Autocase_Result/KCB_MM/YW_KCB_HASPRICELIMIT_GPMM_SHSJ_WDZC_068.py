...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_068(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_068
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_068(self):
