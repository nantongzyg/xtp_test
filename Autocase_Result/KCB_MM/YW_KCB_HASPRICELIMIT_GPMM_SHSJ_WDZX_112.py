...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_112(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_112
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_112(self):
        title = '科创板股票交易日五档即成转限价卖-错误的业务类型'
        # 定义当前测试用例的期待值
