...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_021(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_021
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_021(self):
