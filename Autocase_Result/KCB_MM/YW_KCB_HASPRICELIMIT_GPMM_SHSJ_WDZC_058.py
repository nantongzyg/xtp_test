...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_058(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_058
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_058(self):
        title = '上海Ａ股股票交易日五档即成转撤销买——金额溢出（总金额>10亿）'
        # 定义当前测试用例的期待值
