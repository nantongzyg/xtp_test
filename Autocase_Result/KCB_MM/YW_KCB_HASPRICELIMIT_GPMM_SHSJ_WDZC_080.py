...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_080(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_080
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_080(self):
        title = '五档即成转撤销卖-废单再撤单(OMS)'
        # 定义当前测试用例的期待值
