...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_102(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_102
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_102(self):
        title = '上海Ａ股股票交易日五档即成转限价卖——允许的保护价格下限(价格=0.01)'
        # 定义当前测试用例的期待值
