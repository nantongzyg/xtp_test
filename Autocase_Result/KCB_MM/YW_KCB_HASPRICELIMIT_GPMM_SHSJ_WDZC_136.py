...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_136(xtp_test_case):
    def setUp(self):
    ...
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_136
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_136(self):
        title = '交易日五档即成转撤销-T+0买→T+0卖（T-1日未持有证券代码688000)'
        # 定义当前测试用例的期待值
