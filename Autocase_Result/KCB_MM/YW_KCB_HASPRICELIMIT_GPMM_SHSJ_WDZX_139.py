...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_139(xtp_test_case):
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_139')
    ...
    # 
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZX_139(self):
