...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_118(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_118
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_118(self):
        title = '科创板股票交易日限价委托卖-允许的最大申报数量-1（5万-1）'
        # 定义当前测试用例的期待值
