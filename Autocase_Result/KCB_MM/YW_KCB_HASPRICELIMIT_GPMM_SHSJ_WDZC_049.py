...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_049(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_049
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_049(self):
        title = '科创板股票交易日限价委托买-错误的数量（数量<0）'
        # 定义当前测试用例的期待值
