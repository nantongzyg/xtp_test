...
class YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_047(xtp_test_case):
    def setUp(self):
        pass
        
    # YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_047
    def test_YW_KCB_HASPRICELIMIT_GPMM_SHSJ_WDZC_047(self):
        title = '科创板股票交易日五档即成转撤销买-错误的业务类型'
        # 定义当前测试用例的期待值
