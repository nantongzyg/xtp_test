...
class YW_GEM_REGISTERMM_SZSJ_287(xtp_test_case):
    # YW_GEM_REGISTERMM_SZSJ_287
    def test_YW_GEM_REGISTERMM_SZSJ_287(self):
        ...
        stkparm = QueryStkPriceQty('300206', '2', '2', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
