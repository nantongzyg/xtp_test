...
class YW_PGJK_SHKCB_003(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YW_PGJK_SHKCB_003')
    ...
    # 
    def test_YW_PGJK_SHKCB_003(self):
        title = '上海配股缴款--初始'
        # 定义当前测试用例的期待值
        ...
        self.assertEqual(rs['用例测试结果'], True) # 210
