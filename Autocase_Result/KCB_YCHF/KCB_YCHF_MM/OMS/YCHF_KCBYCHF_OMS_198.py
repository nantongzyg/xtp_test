...
class YCHF_KCBYCHF_OMS_198(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_198')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_198(self):
        title = 'OMS断网（沪A五档即成转限价：分笔成交_累积成交金额 < 累积成交费用）'
        # 定义当前测试用例的期待值
