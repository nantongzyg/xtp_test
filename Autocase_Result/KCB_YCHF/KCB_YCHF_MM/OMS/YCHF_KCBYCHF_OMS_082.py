...
class YCHF_KCBYCHF_OMS_082(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_082')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_082(self):
        title = '停止OMS服务（沪A五档即成转撤单全撤卖出）'
        # 定义当前测试用例的期待值
