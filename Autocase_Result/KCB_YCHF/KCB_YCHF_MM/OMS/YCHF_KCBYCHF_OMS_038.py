...
class YCHF_KCBYCHF_OMS_038(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_038')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_038(self):
        title = '停止OMS服务(沪A对手方最优转限价部成买入)'
        # 定义当前测试用例的期待值
