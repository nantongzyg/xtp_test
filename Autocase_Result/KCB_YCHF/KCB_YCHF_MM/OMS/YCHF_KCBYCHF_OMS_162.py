...
class YCHF_KCBYCHF_OMS_162(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_162')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_162(self):
        title = 'OMS断网（沪A对手方最优转限价内部撤单买入）'
        # 定义当前测试用例的期待值
