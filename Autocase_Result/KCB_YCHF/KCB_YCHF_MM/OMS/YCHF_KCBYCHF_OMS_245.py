...
class YCHF_KCBYCHF_OMS_245(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_245')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_245(self):
        title = 'OMS断网（沪A对手方最优转限价：单笔成交_成交金额 < 手续费）'
        # 定义当前测试用例的期待值
