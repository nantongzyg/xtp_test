...
class YCHF_KCBYCHF_OMS_022(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_022')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_022(self):
        title = '停止OMS服务（沪A五档即成转撤单部撤买入）'
        # 定义当前测试用例的期待值
