...
class YCHF_KCBYCHF_OMS_228(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_228')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_228(self):
        title = 'OMS断网（沪A本方最优：单笔成交_成交金额 < 手续费）'
        # 定义当前测试用例的期待值
