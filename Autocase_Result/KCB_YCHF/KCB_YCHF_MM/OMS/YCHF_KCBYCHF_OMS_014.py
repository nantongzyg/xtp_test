...
class YCHF_KCBYCHF_OMS_014(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_014')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_014(self):
        title = '停止OMS服务（沪A五档即成转限价全成买入）'
        # 定义当前测试用例的期待值
