...
class YCHF_KCBYCHF_OMS_220(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_220')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_220(self):
        title = 'OMS断网（沪A本方最优内部撤单卖出）'
        # 定义当前测试用例的期待值
