...
class YCHF_KCBYCHF_OMS_040(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_040')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_040(self):
        title = '停止OMS服务（沪A对手方最优转限价全撤买入）'
        # 定义当前测试用例的期待值
