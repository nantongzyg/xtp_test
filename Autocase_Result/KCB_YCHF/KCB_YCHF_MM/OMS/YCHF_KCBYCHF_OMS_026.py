...
class YCHF_KCBYCHF_OMS_026(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_026')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_026(self):
        title = '停止OMS服务(沪A本方最优初始买入)'
        # 定义当前测试用例的期待值
