...
class YCHF_KCBYCHF_OMS_145(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_145')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_145(self):
        title = 'OMS断网(沪A五档即成转撤单初始买入)'
        # 定义当前测试用例的期待值
