...
class YCHF_KCBYCHF_OMS_083(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_083')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_083(self):
        title = '停止OMS服务（沪A五档即成转撤单废单卖出）'
        # 定义当前测试用例的期待值
