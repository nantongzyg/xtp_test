...
class YCHF_KCBYCHF_OMS_SHOffer_096(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_SHOffer_096')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_SHOffer_096(self):
        title = '先重启上海报盘再重启OMS（沪A对方最优转限价撤废卖出）'
        # 定义当前测试用例的期待值
