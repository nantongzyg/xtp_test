...
class YCHF_KCBYCHF_OMS_SHOffer_010(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_SHOffer_010')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_SHOffer_010(self):
        title = '先重启上海报盘再重启OMS（沪A最优五档即成转限价全成买入）'
        # 定义当前测试用例的期待值
