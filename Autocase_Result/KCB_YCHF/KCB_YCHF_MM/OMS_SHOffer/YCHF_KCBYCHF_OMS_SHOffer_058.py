...
class YCHF_KCBYCHF_OMS_SHOffer_058(xtp_test_case):
    def setUp(self):
    ...
    # YCHF_KCBYCHF_OMS_SHOffer_058
    def test_YCHF_KCBYCHF_OMS_SHOffer_058(self):
        title = '先重启上海报盘再重启OMS（沪A限价：买入最低特殊费用=0）'
        # 定义当前测试用例的期待值
