...
class YCHF_KCBYCHF_OMS_SHOffer_059(xtp_test_case):
    def setUp(self):
    ...
    # YCHF_KCBYCHF_OMS_SHOffer_059
    def test_YCHF_KCBYCHF_OMS_SHOffer_059(self):
        title = '先重启上海报盘再重启OMS（沪A限价：卖出最低特殊费用=0）'
        # 定义当前测试用例的期待值
