...
class YCHF_KCBYCHF_OMS_SHOffer_076(xtp_test_case):
    def setUp(self):
    ...
    # YCHF_KCBYCHF_OMS_SHOffer_076
    def test_YCHF_KCBYCHF_OMS_SHOffer_076(self):
        title = '先重启上海报盘再重启OMS（沪A最优五档即成转限价：卖出最低特殊费用=0）'
        # 定义当前测试用例的期待值
