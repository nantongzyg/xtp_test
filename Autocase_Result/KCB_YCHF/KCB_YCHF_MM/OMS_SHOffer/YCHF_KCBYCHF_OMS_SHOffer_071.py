...
class YCHF_KCBYCHF_OMS_SHOffer_071(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_OMS_SHOffer_071')
    ...
    # 
    def test_YCHF_KCBYCHF_OMS_SHOffer_071(self):
        title = '先重启上海报盘再重启OMS（沪A最优五档即成转限价：分笔成交_累积成交金额 < 累积成交费用）'
        # 定义当前测试用例的期待值
