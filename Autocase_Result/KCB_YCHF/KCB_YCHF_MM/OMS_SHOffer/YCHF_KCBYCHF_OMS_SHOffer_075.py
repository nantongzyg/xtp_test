...
class YCHF_KCBYCHF_OMS_SHOffer_075(xtp_test_case):
    def setUp(self):
    ...
    # YCHF_KCBYCHF_OMS_SHOffer_075
    def test_YCHF_KCBYCHF_OMS_SHOffer_075(self):
        title = '先重启上海报盘再重启OMS（沪A最优五档即成转限价：买入最低特殊费用=0）'
        # 定义当前测试用例的期待值
