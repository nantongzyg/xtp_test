...
class YCHF_KCBYCHF_OMS_SHOffer_124(xtp_test_case):
    def setUp(self):
    ...
    # YCHF_KCBYCHF_OMS_SHOffer_124
    def test_YCHF_KCBYCHF_OMS_SHOffer_124(self):
        title = '先重启上海报盘再重启OMS（沪A本方最优：卖出最低特殊费用=0）'
        # 定义当前测试用例的期待值
