...
class YCHF_KCBYCHF_SHBP_236(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_236')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_236(self):
        title = '断开上海报盘网络连接（沪A最优五档即成转限价：分笔成交_撤单_累积成交金额 >= 手续费）'
        # 定义当前测试用例的期待值
