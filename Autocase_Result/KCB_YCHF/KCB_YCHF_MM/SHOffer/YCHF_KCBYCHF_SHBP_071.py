...
class YCHF_KCBYCHF_SHBP_071(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_071')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_071(self):
        title = '断开上海报盘网络连接（沪A对手方最优转限价初始买入)'
        # 定义当前测试用例的期待值
