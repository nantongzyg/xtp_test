...
class YCHF_KCBYCHF_SHBP_226(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_226')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_226(self):
        title = '断开上海报盘网络连接（沪A最优五档即成转限价内部撤单卖出）'
        # 定义当前测试用例的期待值
