...
class YCHF_KCBYCHF_SHBP_244(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_244')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_244(self):
        title = '断开上海报盘网络连接（沪A最优五档即成转撤单：单笔成交_成交金额 < 手续费）'
        # 定义当前测试用例的期待值
