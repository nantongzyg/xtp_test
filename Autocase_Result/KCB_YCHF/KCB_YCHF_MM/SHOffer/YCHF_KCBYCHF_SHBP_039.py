...
class YCHF_KCBYCHF_SHBP_039(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_039')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_039(self):
        title = '重启上海报盘(沪A本方最优初始买入)'
        # 定义当前测试用例的期待值
