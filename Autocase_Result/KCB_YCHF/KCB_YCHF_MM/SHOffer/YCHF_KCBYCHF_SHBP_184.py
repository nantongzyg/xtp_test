...
class YCHF_KCBYCHF_SHBP_184(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_184')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_184(self):
        title = '重启上海报盘（沪A对手方最优转限价：分笔成交_累积成交金额 >= 手续费 且手续费大于最小值）'
        # 定义当前测试用例的期待值
