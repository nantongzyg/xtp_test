...
class YCHF_KCBYCHF_SHBP_084(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_084')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_084(self):
        title = '重启数据库服务（沪A限价废单买入）'
        # 定义当前测试用例的期待值
