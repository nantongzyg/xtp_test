...
class YCHF_KCBYCHF_SHBP_359(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_359')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_359(self):
        title = '重启数据库服务（沪A本方最优：单笔成交_成交金额 < 手续费）'
        # 定义当前测试用例的期待值
