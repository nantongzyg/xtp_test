...
class YCHF_KCBYCHF_SHBP_304(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_304')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_304(self):
        title = '重启数据库服务（沪A最优五档即成转限价废单卖出）'
        # 定义当前测试用例的期待值
