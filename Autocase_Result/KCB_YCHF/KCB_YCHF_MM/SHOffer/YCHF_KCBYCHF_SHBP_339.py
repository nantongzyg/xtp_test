...
class YCHF_KCBYCHF_SHBP_339(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_339')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_339(self):
        title = '重启数据库服务(沪A对手方最优转限价初始卖出)'
        # 定义当前测试用例的期待值
