...
class YCHF_KCBYCHF_SHBP_306(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_306')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_306(self):
        title = '重启数据库服务（沪A最优五档即成转限价全撤卖出）'
        # 定义当前测试用例的期待值
