...
class YCHF_KCBYCHF_SHBP_175(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_175')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_175(self):
        title = '重启上海报盘（沪A对方最优转限价内部撤单卖出）'
        # 定义当前测试用例的期待值
