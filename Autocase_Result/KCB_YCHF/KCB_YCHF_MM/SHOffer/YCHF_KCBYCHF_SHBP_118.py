...
class YCHF_KCBYCHF_SHBP_118(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_118')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_118(self):
        title = '重启数据库服务（沪A本方最优全撤买入）'
        # 定义当前测试用例的期待值
