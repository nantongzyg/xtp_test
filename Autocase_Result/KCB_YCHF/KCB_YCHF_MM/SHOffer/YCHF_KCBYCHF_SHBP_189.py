...
class YCHF_KCBYCHF_SHBP_189(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_189')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_189(self):
        title = '重启上海报盘（沪A本方最优废单卖出）'
        # 定义当前测试用例的期待值
