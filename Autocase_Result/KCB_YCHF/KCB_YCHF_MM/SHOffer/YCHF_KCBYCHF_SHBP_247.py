...
class YCHF_KCBYCHF_SHBP_247(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_247')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_247(self):
        title = '断开上海报盘网络连接（沪A最优五档即成转撤单：分笔成交_累积成交金额 >= 手续费 且手续费小于最小值）'
        # 定义当前测试用例的期待值
