...
class YCHF_KCBYCHF_SHBP_200(xtp_test_case):
    def setUp(self):
        #sql_transfer = SqlData_Transfer()
        #sql_transfer.transfer_fund_asset('YCHF_KCBYCHF_SHBP_200')
    ...
    # 
    def test_YCHF_KCBYCHF_SHBP_200(self):
        title = '重启上海报盘（沪A本方最优：分笔成交_累积成交金额 >= 手续费 且手续费小于最小值）'
        # 定义当前测试用例的期待值
