...
class YCHF_XGSGYCHF_OMS_SHOFFER_004(xtp_test_case):
    def setUp(self):
    ...
    # YCHF_XGSGYCHF_OMS_SHOFFER_004
    def test_YCHF_XGSGYCHF_OMS_SHOFFER_004(self):
        title = '先重启上海报盘再重启OMS（沪A-内部撤单）'
        # 定义当前测试用例的期待值
        ...
        self.assertEqual(rs['报单测试结果'], True) # 214
