...
class YW_ETFMM_SHSJ_079_K(xtp_test_case):
    # YW_ETFMM_SHSJ_079
    def test_YW_ETFMM_SHSJ_079_K(self):
        title = '交易日五档即成转限价卖-先卖零头股再卖整数股'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('515063', '1', '15', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
