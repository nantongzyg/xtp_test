...
class YW_ETFMM_SHSJ_083_K(xtp_test_case):
    # YW_ETFMM_SHSJ_083
    def test_YW_ETFMM_SHSJ_083_K(self):
        title = '交易日五档即成转限价卖-T+0卖→T+0买'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('515067', '1', '15', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
