...
class YW_ETFMM_SZSJ_310_K(xtp_test_case):
    # YW_ETFMM_SZSJ_310_D
    def test_YW_ETFMM_SZSJ_310_K(self):
        title = '交易日本方最优卖-T+0买→T+0卖（已持有证券代码）'
        # 定义当前测试用例的期待值
        ...
        stkparm = QueryStkPriceQty('158248', '2', '15', '2', '0', 'S', case_goal['期望状态'], Api)
        # 如果下单参数获取失败，则用例失败
