...
class YW_GGQQ_YWFSJHA_GOU_234(xtp_test_case):
    # YW_GGQQ_YWFSJHA_GOU_234

    def test_YW_GGQQ_YWFSJHA_GOU_234(self):
        title='买平（义务方平仓）：FOK市价全成或撤销-错误的价格条件'
        #定义当前测试用例的期待值
        ...
        case_goal = {
            '期望状态': '废单',
            'errorID': 11110006,
            'errorMSG': queryOrderErrorMsg(11110006),
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
