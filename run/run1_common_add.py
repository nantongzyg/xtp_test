...
def runcase_SZ_GPMM():
    runcase_common.runCases(path,  u'普通业务自动化用例_新增.xlsx',u'深圳限价')
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'深圳市价')

#中小板
def runcase_SZ_MEDIUM():
    runcase_common.runCases(path, u'mediumm.xlsx',u'深圳限价')
    runcase_common.runCases(path, u'mediumm.xlsx', u'深圳市价')

#创业板
def runcase_SZ_GEM():
    runcase_common.runCases(path, u'gem.xlsx',u'深圳限价')
    runcase_common.runCases(path, u'gem.xlsx', u'深圳市价')

#风险警示
def runcase_SZ_FXJSMM():
    runcase_common.runCases(path, u'fxjsmm.xlsx',u'深圳限价')
#退市整理
def runcase_SZ_TSZLMM():
    runcase_common.runCases(path, u'tszlmm.xlsx',u'深圳限价')

def runcase_SZ_ETFMMD():
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'深圳限价单市场')
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'深圳市价单市场')

def runcase_SZ_ETFMMK():
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'深圳限价跨市场')
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'深圳市价跨市场')

def runcase_SZ_FJZJJMM():
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'分级子基金深圳限价')
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'分级子基金深圳市价')

def runcase_SZ_ReverseRepo():
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'逆回购_深圳')

def runcase_SZ_IPO():
    runcase_ipo.runCases(path, u'普通业务自动化用例_新增.xlsx', u'新股申购_深圳')

def runcase_SZ_AllotmentPayment():
    runcase_allPayment.runCases(path, u'普通业务自动化用例_新增.xlsx', u'配股缴款_深圳')

def runcase_SZ_KZZMM():
    runcase_common.runCases(path, u'kzz.xlsx', u'深圳限价')

def runcase_SH_GPMM():
    runcase_common.runCases(path,  u'普通业务自动化用例_新增.xlsx',u'上海限价')
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'上海市价')

#退市整理
def runcase_SH_TSZLMM():
    runcase_common.runCases(path, u'tszlmm.xlsx',u'上海限价')

#风险警示
def runcase_SH_FXJSMM():
    runcase_common.runCases(path, u'fxjsmm.xlsx',u'上海限价')

def runcase_SH_ETFMMD():
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'上海限价单市场')
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'上海市价单市场')


def runcase_SH_ETFMMK():
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'上海限价跨市场')
    runcase_common.runCases(path, u'ETF买卖_新增.xlsx', u'上海市价跨市场')


def runcase_SH_ReverseRepo():
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'逆回购_上海')


def runcase_SH_IPO():
    runcase_ipo.runCases(path, u'普通业务自动化用例_新增.xlsx', u'新股申购_上海')


def runcase_SH_AllotmentPayment():
    runcase_allPayment.runCases(path, u'普通业务自动化用例_新增.xlsx', u'配股缴款_上海')

def runcase_SH_HBJJ():
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'交易型货币基金买卖上海限价')
    runcase_common.runCases(path, u'普通业务自动化用例_新增.xlsx', u'交易型货币基金买卖上海市价')

def runcase_SH_KZZMM():
    runcase_common.runCases(path, u'kzz.xlsx', u'上海限价')
...
def runcase_commoncase():
   ...
   # ---------市场分割线----------
    ...
    #runcase_SH_IPO()
def runcase_Restart():
    os.system('bash /home/yhl2/workspace/xtp_test/Autocase_Result/RESTART/test.sh')
