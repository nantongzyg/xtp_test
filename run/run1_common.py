...
sys.path.append('/home/yhl2/workspace/xtp_test/Autocase_Result/GEM_REGISTER_IPO')
...
def runcase_SZ_GEM_REGISTER():
    runcase_common.runCases(path, u'gem_register.xlsx',u'深圳限价')
    runcase_common.runCases(path, u'gem_register.xlsx', u'深圳市价')
#创业板_注册制_新股申购
def runcase_SZ_GEM_REGISTER_IPO():
    runcase_ipo.runCases(path, u'gem_register.xlsx',u'新股申购_深圳')
#风险警示
