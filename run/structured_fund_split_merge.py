...
def runCases(path, filename):
    ...
    case_service = CaseServiceSplitMerge.CaseService(excel_file)
...
if __name__ == '__main__':
    # py存放路径
    casepath = '/home/yhl2/workspace/xtp_test/StructuredFund/splitMerge'
    cases = getCases(casepath)
    path = '/home/yhl2/workspace/xtp_test/utils'
    runCases(path, 'structured_fund_creation_redemption.xlsx')
