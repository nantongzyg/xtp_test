...
class XTPTradeApi(TradeApi):
    ...
    def __init__(self):
        ...
        self.queryOrderByPageHandle = lambda data, req_count, order_sequence, query_reference, request_id, is_last: data
        self.queryTradeByPageHandle = lambda data, req_count, trade_sequence, query_reference, request_id, is_last: data
    ...
    # ----------------------------------------------------------------------
    def onQueryOrderByPage(self, data, req_count, order_sequence, query_reference, request_id, is_last):
        """分页请求查询报单响应"""
        if self.queryOrderByPageHandle:
            self.queryOrderByPageHandle(data, req_count, order_sequence, query_reference, request_id, is_last)

    # ----------------------------------------------------------------------
    def onQueryTradeByPage(self, data, req_count, trade_sequence, query_reference, request_id, is_last):
        """分页请求查询成交响应"""
        if self.queryTradeByPageHandle:
            self.queryTradeByPageHandle(data, req_count, trade_sequence, query_reference, request_id, is_last)
    ...
    # ----------------------------------------------------------------------
    def QueryOrdersByPage(self, query, request_id=0):
        """请求查询报单"""
        
        if request_id == 0:
            request_id = self.getRequestId()
        return super(XTPTradeApi, self).QueryOrdersByPage(query, self.session_id, request_id)

    # ----------------------------------------------------------------------
    def QueryTradesByPage(self, query, request_id=0):
        """请求查询报单"""

        if request_id == 0:
            request_id = self.getRequestId()
        return super(XTPTradeApi, self).QueryTradesByPage(query, self.session_id, request_id)
    ...
    # ----------------------------------------------------------------------
    def setQueryOrderByPageHandle(self,func):
        """"分页请求查询报单响应"""
        self.queryOrderByPageHandle = func
         
        # ----------------------------------------------------------------------
    def setQueryTradeByPageHandle(self,func):
        """"分页请求查询成交响应"""
        self.queryTradeByPageHandle = func
