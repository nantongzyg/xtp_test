...
CONST_TRADE_CLIENT_ID = 113            # 客户端 id
# Config.trade.save_file_path
CONST_TRADE_SAVE_FILE_PATH = 'null'   # 存贮订阅信息文件的目录
# Config.trade.ip
#CONST_TRADE_IP = '10.26.134.192'
CONST_TRADE_IP = '10.29.193.60'
# Config.trade.port
CONST_TRADE_PORT = 8002            # 端口号
# Config.trade.name
#CONST_TRADE_USER = 'testshopt01tgt' 
CONST_TRADE_USER = 'testshopt02'          # 帐号
