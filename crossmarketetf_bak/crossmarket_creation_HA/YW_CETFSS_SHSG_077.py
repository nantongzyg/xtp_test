...
class YW_CETFSS_SHSG_077(xtp_test_case):

    def test_YW_CETFSS_SHSG_077(self):
        # -----------ETF申购-------------
        title = ('上海ETF申购真实ETF-资金充足，申购所需的成分股不足（可现金替代的比例<=最大现金替代比例，且禁止现金替代的成分股不足）')
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            ...
            'forbidden_unit': 0.5,  # 买入禁止现金替代成分股份数
