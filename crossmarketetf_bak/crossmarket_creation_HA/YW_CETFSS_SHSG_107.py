...
class YW_CETFSS_SHSG_107(xtp_test_case):

    def test_YW_CETFSS_SHSG_107(self):
        # -----------ETF申购-------------
        title = ('上海ETF申购--数量溢出（99000000）实际最大值')
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            'ticker': '512070',  # etf代码
            'optional_unit': 99.0,  # 买入允许现金替代成分股份数
            'forbidden_unit': 99.0,  # 买入禁止现金替代成分股份数
            'etf_unit': 99.0   # etf申购单位数
        }
