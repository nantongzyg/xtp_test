...
class YW_CETFSS_SHSG_051(xtp_test_case):

    def test_YW_CETFSS_SHSG_051(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--可深市股票退补现金替代：T-1日部分成分股&资金不足&计算现金比例=最大现金比例→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            ...
            'component_unit_sell': 100.0 # 成分股卖出单位数
        }
