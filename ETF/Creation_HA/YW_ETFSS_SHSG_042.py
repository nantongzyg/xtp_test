...
class YW_ETFSS_SHSG_042(xtp_test_case):

    def test_YW_ETFSS_SHSG_042(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--可现金替代：T日成分股可申购1.5unitETF&资金足额→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            'ticker': '590550',  # etf代码
            'component_unit_buy': 1.5,  # 成分股买入数量或单位,大于等于100为数量，否则为份数
            'etf_unit': 1,  # etf申购单位数
