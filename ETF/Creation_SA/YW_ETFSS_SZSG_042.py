...
class YW_ETFSS_SZSG_043(xtp_test_case):

    def test_YW_ETFSS_SZSG_043(self):
        # -----------ETF申购-------------
        title = '深圳ETF申购--可现金替代：（T-1日+T日）成分股可申购1.5unit&资金足额&→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            'ticker': '169128',  # etf代码
            'component_unit_buy': 0.5,  # 成分股买入数量或单位,大于等于100为数量，否则为份数
            'etf_unit': 1,  # etf申购单位数
