...
class S_REDEMPTION_HA_ETF_ETFSH003(xtp_test_case):

    def test_S_REDEMPTION_HA_ETF_ETFSH003(self):
        # -----------ETF赎回-------------
        title = '上海ETF赎回--禁止现金替代：T-1日ETF拥股量1unit→T日赎回ETF'
        # 定义当前测试用例的期待值
        ...
        for stk_info in etf_component_info:
            ...
            wt_reqs = {
                ...
                'quantity':
                    quantity,
				'position_effect':
					Api.const.XTP_POSITION_EFFECT_TYPE['XTP_POSITION_EFFECT_INIT']上
            }
            ParmIni(Api, case_goal['期望状态'], wt_reqs['price_type'])
