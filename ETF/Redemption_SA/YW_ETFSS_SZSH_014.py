...
class YW_ETFSS_SZSH_014(xtp_test_case):

    def test_YW_ETFSS_SZSH_014(self):
        # -----------ETF赎回-------------
        title = '深圳ETF赎回--必须全部现金替代：T日ETF拥股量2unit→T日赎回ETF'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            'ticker': '179905',  # etf代码
            'etf_unit': 2,  # etf赎回单位数
            'etf_unit_buy': 2,  # etf买入单位数
            'etf_unit_sell': 2,  # etf卖出单位数
            'component_unit_sell': 2  # 成分股卖出单位数
        }
