...
class YW_CETFSS_SHSG_063(xtp_test_case):

    def test_YW_CETFSS_SHSG_063(self):
        # -----------ETF申购-------------
        title = ('上海ETF申购--可深市股票退补现金替代：T日成分股可申购1.5unitETF&资金足额→T日申购ETF')
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            ...
            'component_unit_sell': 1.5  # 成分股卖出单位数
        }
