...
class YW_CETFSS_SHSH_038(xtp_test_case):

    def test_YW_CETFSS_SHSH_038(self):
        # -----------ETF赎回-------------
        title = ('上海ETF赎回--可深市股票退补现金替代：T日ETF拥股量2unit→T日赎回ETF')
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            'ticker': '530520',  # etf代码
            'etf_unit_buy': 2.0,  # etf买入单位数
            'etf_unit': 2.0,  # etf赎回单位数
            'etf_unit_sell': 1.0,  # etf卖出单位数
            'component_unit_sell': 2.0  # 成分股卖出单位数
        }
