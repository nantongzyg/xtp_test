...
# -*- encoding: utf-8 -*-
import time
from cetf_utils import get_valid_amount


#根据etf代码买入一篮子股票，只买非必须现金替代部分
def cetf_basket_add(Api, market, etf_code, component_unit):
    #查询一篮子股票有哪些
    query = {
        'market': market,
        'ticker': etf_code,
    ...
    def on_QueryETFBasket(data, error, request_id, is_last):
        ...
        if data['quantity'] != 0:
            ...
            wt_reqs = {
                ...
                'price_type': Api.const.XTP_PRICE_TYPE[
