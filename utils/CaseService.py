...
class CaseService():
    ...
    def gen_specify_casepy(self, pyname,casepath):
        ...
        try:
            ...
            elif case_para_tuple[-1] == 401:
                case_str = templet_case_str401 % case_para_tuple
            elif case_para_tuple[-1] == 402:
                case_str = templet_case_str402 % case_para_tuple
            elif case_para_tuple[-1] == 403:
                case_str = templet_case_str403 % case_para_tuple
            elif case_para_tuple[-1] == 404:
                case_str = templet_case_str404 % case_para_tuple
            elif case_para_tuple[-1] == 405:
                case_str = templet_case_str405 % case_para_tuple
            elif case_para_tuple[-1] == 406:
                case_str = templet_case_str406 % case_para_tuple
            elif case_para_tuple[-1] == 407:
                case_str = templet_case_str407 % case_para_tuple
            elif case_para_tuple[-1] == 408:
                case_str = templet_case_str408 % case_para_tuple
            elif case_para_tuple[-1] == 409:
                case_str = templet_case_str409 % case_para_tuple
            elif case_para_tuple[-1] == 410:
                case_str = templet_case_str410 % case_para_tuple
            elif case_para_tuple[-1] == 411:
                case_str = templet_case_str411 % case_para_tuple
            elif case_para_tuple[-1] == 412:
                case_str = templet_case_str412 % case_para_tuple
            elif case_para_tuple[-1] == 413:
                case_str = templet_case_str413 % case_para_tuple
            elif case_para_tuple[-1] == 414:
                case_str = templet_case_str414 % case_para_tuple
            elif case_para_tuple[-1] == 415:
                case_str = templet_case_str415 % case_para_tuple
            elif case_para_tuple[-1] == 416:
                case_str = templet_case_str416 % case_para_tuple
            elif case_para_tuple[-1] == 417:
                case_str = templet_case_str417 % case_para_tuple
            elif case_para_tuple[-1] == 418:
                case_str = templet_case_str418 % case_para_tuple
            elif case_para_tuple[-1] == 419:
                case_str = templet_case_str419 % case_para_tuple
            elif case_para_tuple[-1] == 420:
                case_str = templet_case_str420 % case_para_tuple
            elif case_para_tuple[-1] == 421:
                case_str = templet_case_str421 % case_para_tuple
            elif case_para_tuple[-1] == 422:
                case_str = templet_case_str422 % case_para_tuple
            elif case_para_tuple[-1] == 423:
                case_str = templet_case_str423 % case_para_tuple
            elif case_para_tuple[-1] == 424:
                case_str = templet_case_str424 % case_para_tuple
            elif case_para_tuple[-1] == 425:
                case_str = templet_case_str425 % case_para_tuple
            elif case_para_tuple[-1] == 426:
                case_str = templet_case_str426 % case_para_tuple
            elif case_para_tuple[-1] == 427:
                case_str = templet_case_str427 % case_para_tuple
            elif case_para_tuple[-1] == 428:
                case_str = templet_case_str428 % case_para_tuple
            elif case_para_tuple[-1] == 429:
                case_str = templet_case_str429 % case_para_tuple
            elif case_para_tuple[-1] == 430:
                case_str = templet_case_str430 % case_para_tuple
            elif case_para_tuple[-1] == 431:
                case_str = templet_case_str431 % case_para_tuple
            elif case_para_tuple[-1] == 432:
                case_str = templet_case_str432 % case_para_tuple
            elif case_para_tuple[-1] == 433:
                case_str = templet_case_str433 % case_para_tuple
            else:
                pass
