    ...
    def gen_specify_casepy(self, pyname,casepath):
        ...
        try:
            ...
            if case_para_tuple[-1] == 0:
                case_str=templet_case_str32 % case_para_tuple
            elif case_para_tuple[-1] == 2:
                case_str = templet_case_str33 % case_para_tuple
            # elif case_para_tuple[-1] == 4:
            #     case_str = templet_case_str13 % case_para_tuple
            elif case_para_tuple[-1] == 5:
                case_str = templet_case_str34 % case_para_tuple
            elif case_para_tuple[-1] == 6:
                case_str = templet_case_str35 % case_para_tuple
            # elif case_para_tuple[-1] == 2:
