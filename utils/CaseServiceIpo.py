    ...
    def gen_specify_casepy(self, pyname,casepath):
        ...
        try:
            ...
            if case_para_tuple[-1] == 0:
                ...
                case_str=templet_case_str12 % case_para_tuple
            elif case_para_tuple[-1] == 434:
                case_str=templet_case_str434 % case_para_tuple
            elif case_para_tuple[-1] == 435:
                case_str=templet_case_str435 % case_para_tuple
            elif case_para_tuple[-1] == 436:
                case_str=templet_case_str436 % case_para_tuple
            elif case_para_tuple[-1] == 1:
                case_str = templet_case_str19 % case_para_tuple
            else:
                pass
