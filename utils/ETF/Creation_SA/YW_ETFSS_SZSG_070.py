...
class YW_ETFSS_SZSG_070(xtp_test_case):

    def test_YW_ETFSS_SZSG_070(self):
        # -----------ETF申购-------------
        title = '深圳ETF申购--错误的数量(数量<0)'
        # 定义当前测试用例的期待值
        ...
        case_goal = {
            ...
            '期望状态': '废单',
            'errorID': 10210301,
            'errorMSG': '[XTP:10210301]Insert order failed:invalid parameters',
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
