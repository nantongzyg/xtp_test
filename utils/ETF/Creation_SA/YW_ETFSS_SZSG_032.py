...
class YW_ETFSS_SZSG_032(xtp_test_case):

    def test_YW_ETFSS_SZSG_032(self):
        # -----------ETF申购-------------
        title = '深圳ETF申购--可现金替代：T日部分成分股&' \
        ...
        unit_info = {
            'ticker': '169118',  # etf代码
            'component_unit_buy': 100,  # 成分股买入数量
            'etf_unit': 1,  # etf申购单位数
            'component_unit_sell': 100 # 成分股卖出数量
        }
