...
class YW_ETFSS_SZSG_046(xtp_test_case):

    def test_YW_ETFSS_SZSG_046(self):
        # -----------ETF申购-------------
        title = '深圳ETF申购真实ETF-资金充足，申购所需的成分股不足' \
                '（可现金替代的比例<=最大现金替代比例，且禁止现金替代的成分股不足）'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            ...
            'forbidden_unit': 0,  # 买入允许现金替代成分股份数
            'etf_unit': 1,  # etf申购单位数
        }
