...
class YW_ETFSS_SHSG_067(xtp_test_case):

    def test_YW_ETFSS_SHSG_067(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--不允许申购（ETF_baseinfo）'
        # 定义当前测试用例的期待值
        ...
        case_goal = {
            ...
            '期望状态': '废单',
            'errorID': 11010212,
            'errorMSG': 'creationRedemption or redemption of etf is prohibited.',
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
