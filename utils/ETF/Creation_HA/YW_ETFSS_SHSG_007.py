...
class YW_ETFSS_SHSG_007(xtp_test_case):

    def test_YW_ETFSS_SHSG_007(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--禁止现金替代：T-1日无成分股→T日买入成分股可以申购1.5unitETF→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            'ticker': '590170',  # etf代码
            'component_unit_buy': 1.5,  # 成分股买入单位数
            'etf_unit': 1,  # etf申购单位数
