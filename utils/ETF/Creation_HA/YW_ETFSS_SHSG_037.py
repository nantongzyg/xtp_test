...
class YW_ETFSS_SHSG_037(xtp_test_case):

    def test_YW_ETFSS_SHSG_037(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--可现金替代：（T-1日+T日）部分成分股&资金不足&计算现金比例<最大现金比例→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        unit_info = {
            ...
            'etf_unit': 1,  # etf申购单位数
            'component_unit_sell': 0.5  # 成分股卖出数量或单位,大于等于100为数量，否则为份数
        }
