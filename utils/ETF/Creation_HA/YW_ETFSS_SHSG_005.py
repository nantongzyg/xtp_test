...
class YW_ETFSS_SHSG_005(xtp_test_case):

    def test_YW_ETFSS_SHSG_005(self):
        title = '上海ETF申购--禁止现金替代：T-1日无成分股→T日买入成分股可以申购0.5unitETF→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        case_goal = {
            ...
            '期望状态': '废单',
            'errorID': 11010123,
            'errorMSG': 'Invalid security quantity.',
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
