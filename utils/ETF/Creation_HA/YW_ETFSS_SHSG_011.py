...
sys.path.append("/home/yhl/workspace/xtp_test//mysql")
from QueryOrderErrorMsg import queryOrderErrorMsg

class YW_ETFSS_SHSG_011(xtp_test_case):

    def test_YW_ETFSS_SHSG_011(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--必须全部现金替代：T-1日无成分股&可用资金不足→T日申购ETF'
        # 定义当前测试用例的期待值
        ...
        case_goal = {
            ...
            '期望状态': '废单',
            'errorID': 11010120,
            #'errorMSG': 'Failed to check amount.',
        ...
        quantity = int(unit_info['etf_unit'] * stkparm['最小申赎单位'])  # 二级市场卖出的etf数量
        ...
        for stk_info in etf_component_info:
            ...
            components_total = int(components_share * unit_info['component_unit_sell'])
