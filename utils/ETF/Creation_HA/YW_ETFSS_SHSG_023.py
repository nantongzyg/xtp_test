...
class YW_ETFSS_SHSG_023(xtp_test_case):

    def test_YW_ETFSS_SHSG_023(self):
        # -----------ETF申购-------------
        title = '上海ETF申购--可现金替代：T-1日部分成分股&' \
        ...
        case_goal = {
            ...
            '期望状态': '废单',
            'errorID': 11010203,
            'errorMSG': 'Cash ratio is overflow in etf creationRedemption.',
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
        ...
        unit_info = {
            'ticker': '590350',  # etf代码
            'etf_unit': 1,  # etf申购单位数
            'component_unit_sell': 100  # 成分股卖出单位数, 为方便测试, T-1日买入成分股和T日卖出成分股数量取0.5unit
        }
