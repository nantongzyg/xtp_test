...
class HQ_16_081(xtp_test_case):
    ...
    def subTickByTick(self, Api, stk_info, case_name, rs_expect):
        ...
        Api.setUnSubTickByTickHandle(on_unsub_tick_by_tick)
    ...
    def test_HQ_16_081(self):
        pyname = 'HQ_16_081'
        client_id = 6
        Api = XTPQuoteApi(client_id)
        Api.Login()
        stk_info = {'ticker': '1872638162837162alksjhgdlkasuhdlkashdalksjdhalksdhalskjdhalk1231212312', 'exchange_id': 1}
