...
def pyname_seq(D1):
    ...
    if D1['对象'].encode('utf-8') != '-':
        print pyname_seq_dict['pyname'] 
        print D1['seq'], D1['对象'].encode('utf-8')
    ...
    def gen_specify_casepy(self, pyname,casepath):
        ...
        try:
            ...
            if case_para_tuple[-1] == 0:
                case_str=templet_case_str37 % case_para_tuple
            elif case_para_tuple[-1] == 2:
                case_str = templet_case_str38 % case_para_tuple
            elif case_para_tuple[-1] == 4:
                case_str = templet_case_str39 % case_para_tuple
            elif case_para_tuple[-1] == 5:
                case_str = templet_case_str2 % case_para_tuple
            elif case_para_tuple[-1] == 6:
                case_str = templet_case_str40 % case_para_tuple
            else:
                pass
