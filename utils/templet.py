...
templet_case_str91:分页接口查询_下单
templet_case_str92:分页接口查询_报单分页查询
templet_case_str93:分页接口查询_成交分页查询
'''
# 买卖case正常测试模板
...
templet_case_str92='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
import sys,time
sys.path.append("/home/yhl2/workspace/xtp_test/xtp/api")
from xtp_test_case import *
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        Api.trade.QueryOrdersByPage({'req_count':%d,'reference':%d})
        time.sleep(0.5)
        rs = len(a)
        self.assertEqual(rs, %d)

if __name__ == '__main__':
    unittest.main()
        '''

templet_case_str93='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
import sys,time
sys.patheappend("/home/yhl2/workspace/xtp_test/xtp/api")
from xtp_test_case import *
sys.path.append("/home/yhl2/workspace/xtp_test/service")
from QueryStkPriceQty import *
from log import *
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        Api.trade.QueryTradesByPage({'req_count':%d,'reference':%d})
        time.sleep(0.5)
        rs = len(a)
        self.assertEqual(rs, %d)
...
if __name__ == '__main__':
    unittest.main()
        '''
# 订单报盘（午休时间）
templet_case_str301='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 上海内部撤单
templet_case_str302='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 上海撤单报盘
templet_case_str303='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有市价委托权限
templet_case_str401='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，无市价委托权限
templet_case_str402='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        # 期望状态：初始、未成交、部成、全成、部撤已报、部撤、已报待撤、已撤、废单、撤废、内部撤单
        # xtp_ID和cancel_xtpID默认为0，不需要变动
        updateSecuRightHasNoJSz()
        updateSecuRightHasNoJSh()
...
# 资金账号无市价委托权限,Secuinfo表有权限
templet_case_str403='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，沪A证券账号无市价委托权限
templet_case_str404='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，深A证券账号无市价委托权限
templet_case_str405='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有风险警示委托权限
templet_case_str406='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        # 期望状态：初始、未成交、部成、全成、部撤已报、部撤、已报待撤、已撤、废单、撤废、内部撤单
        # xtp_ID和cancel_xtpID默认为0，不需要变动
        updateSecuRightHasWSz()
        updateSecuRightHasWSh()
        updateFundRightHasW()
        clear_data_and_restart_all()
        Api.trade.Logout()
        Api.trade.Login()
...
# Fundinfo&Secuinfo表，无风险警示委托权限
templet_case_str407='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        # 期望状态：初始、未成交、部成、全成、部撤已报、部撤、已报待撤、已撤、废单、撤废、内部撤单
        # xtp_ID和cancel_xtpID默认为0，不需要变动
        updateSecuRightHasNoWSz()
        updateSecuRightHasNoWSh()
...
# 资金账号无风险警示委托权限,Secuinfo表有权限
templet_case_str408='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，沪A证券账号无风险警示委托权限
templet_case_str409='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，深A证券账号无风险警示委托权限
templet_case_str410='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有退市整理委托权限
templet_case_str411='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，无退市整理警示委托权限
templet_case_str412='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 资金账号无退市整理委托权限,Secuinfo表有权限
templet_case_str413='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，沪A证券账号无风险警示委托权限
templet_case_str414='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，深A证券账号无退市整理警示委托权限
templet_case_str415='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有创业板委托权限
templet_case_str416='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，无退市整理警示委托权限
templet_case_str417='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        # 期望状态：初始、未成交、部成、全成、部撤已报、部撤、已报待撤、已撤、废单、撤废、内部撤单
        # xtp_ID和cancel_xtpID默认为0，不需要变动
        updateSecuRightHasNoXSz()
        updateSecuRightHasNoXSh()
...
# 资金账号无创业板委托权限,Secuinfo表有权限
templet_case_str418='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Secuinfo表，沪A证券账号有创业板委托权限
templet_case_str419='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo表：资金账号无创业板权限invty1
templet_case_str420='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有科创板委托权限
templet_case_str421='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，无科创版委托权限
templet_case_str422='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表,fund有,secu无
templet_case_str423='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 资金账号无创业板委托权限,Secuinfo表有权限
templet_case_str424='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 资金账号没有科创版权限，Secuinfo表有@权限
templet_case_str425='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 资金账号没有科创版权限，Secuinfo表有@权限,前包后不包
templet_case_str426='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 资金账号没有科创版权限，Secuinfo表有@权限,前不包后包
templet_case_str427='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有买入核准制创业板股票权限
templet_case_str428='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有买入核准制创业板股票和退市整理权限
templet_case_str429='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有买入注册制制创业板股票权限
templet_case_str430='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，拥有买入注册制制创业板股票和退市整理权限
templet_case_str431='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，无买入创业板股票权限
templet_case_str432='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# Fundinfo&Secuinfo表，无买入创业板股票权限,有退市整理权限
templet_case_str433='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 新股申购有科创板核准制权限模板
templet_case_str434 = '''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 新股申购有科创板注册制权限模板
templet_case_str435 = '''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 新股申购无科创板核准制权限和注册制权限模板
templet_case_str436 = '''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 配股模板,有核准制权限
templet_case_str437 = '''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 配股模板,有注册制权限
templet_case_str438 = '''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 配股模板,有核准制注册制权限
templet_case_str439 = '''#!/usr/bin/python
# -*- encoding: utf-8 -*-
