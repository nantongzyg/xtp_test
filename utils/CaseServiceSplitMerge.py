...
def encode_dict_value(D1):
    ...
    if D1['对象'].encode('utf-8') != '-':
        ...
        if int(D1['case_type']) != 2:
            ...
            D2['divide_status'] = int(D1['divide_status'])
    ...
    def gen_specify_casepy(self, pyname):
        ...
        try:
            ...
            if case_para_tuple[-1] == 0:
                case_str=templet_case_str9 % case_para_tuple
            elif case_para_tuple[-1] == 1:
                case_str = templet_case_str10 % case_para_tuple
            elif case_para_tuple[-1] == 2:
                case_str = templet_case_str11 % case_para_tuple
            ...
            if case_para_tuple[-1] != -1 and case_para_dict != {}:
                Autocasefile=os.path.join('../StructuredFund/splitMerge',pyname+'.py')
