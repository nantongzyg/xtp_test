...
templet_case_str201 ~ 210 : 科创板case正常测试模板
templet_case_str211 : 科创板case 异常恢复测试模板
'''
# 买卖case正常测试模板
...
from service.ARmainservice import *
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        if stkparm['返回结果'] is False:
            ...
            rs = serviceTest(Api, case_goal, wt_reqs)
            logger.warning('报单测试结果为' + str(rs['报单测试结果']))
            self.assertEqual(rs['报单测试结果'], True) # %d

if __name__ == '__main__':
    unittest.main()
        '''

# 科创板case 测试模板 不存在的证券代码 
templet_case_str200='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板
templet_case_str201='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关
templet_case_str202='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板 可用资金相关
templet_case_str203='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case 买入最低特殊费用=0  xtp_default_fee_rate表改值
templet_case_str204='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_xtp_default_fee_rate('%s')
        oms_restart()
        Api.trade.Logout()
        Api.trade.Login()
        pass
...
# 科创板:  新股申购 XGSG   
templet_case_str205='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板:  新股申购 XGSG 多次申购模板 :
templet_case_str206='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    ...
    def test_%s(self):
        ...
        # 第二次下单
        title = '上海新股申购--多次申购-第二次下单'
        logger.warning(title)

        case_goal['期望状态'] = '废单'
        case_goal['errorID'] = 11110000
        case_goal['errorMSG'] = '10868'
...
# 科创板:  配股 PG  普通买卖
templet_case_str207='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板:  配股 PG  多次配股
templet_case_str208='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板:  配股 PG  普通买卖  验资案例模板:
templet_case_str209='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板:  配股 PG  关SH match: 初始状态
templet_case_str210='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case 异常恢复 普通测试模板
templet_case_str211='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case 异常恢复 : 买入最低特殊费用=0  xtp_default_fee_rate表改值
templet_case_str212='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
class %s(xtp_test_case):
    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_xtp_default_fee_rate('YW_KCB_YCHF_BUY_001')
        oms_restart()
        Api.trade.Logout()
        Api.trade.Login()
        pass
...
# 科创板case 异常恢复 : 卖出最低特殊费用=0  xtp_default_fee_rate表改值
templet_case_str213='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case 异常恢复 :  新股申购 XGSG    
templet_case_str214='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case 异常恢复:  配股 PG  普通买卖
templet_case_str215='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关  买卖2次
templet_case_str216='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关  
templet_case_str217='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关  
templet_case_str218='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关  
templet_case_str219='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关  
templet_case_str220='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板case正常测试模板  证券代码股份数量相关  
templet_case_str221='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板权限,secuinfo的secu_rights有,fundinfo有
templet_case_str304='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板权限,secuinfo的xtp_secu_rights有,fundinfo有
templet_case_str305='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板权限,secuinfo的xtp_secu_rights有,fundinfo有
templet_case_str306='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板:  配股 PG  多次配股Secuinfo表无权限,前不包后包fundinfo 无权限,
templet_case_str307='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
...
# 科创板:  配股 PG  多次配股Secuinfo表无权限,前后都不包fundinfo 无权限,
templet_case_str308='''#!/usr/bin/python
# -*- encoding: utf-8 -*-
