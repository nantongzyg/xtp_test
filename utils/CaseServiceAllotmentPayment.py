    ...
    def gen_specify_casepy(self, pyname,casepath):
        ...
        try:
            ...
            if case_para_tuple[-1] == 0:
                case_str = templet_case_str14 % case_para_tuple
            elif case_para_tuple[-1] == 4:
                case_str = templet_case_str16 % case_para_tuple
            elif case_para_tuple[-1] == 5:
                case_str = templet_case_str15 % case_para_tuple
            elif case_para_tuple[-1] == 6:
                case_str = templet_case_str18 % case_para_tuple
            elif case_para_tuple[-1] == 437:
                case_str = templet_case_str437 % case_para_tuple
            elif case_para_tuple[-1] == 438:
                case_str = templet_case_str438 % case_para_tuple
            elif case_para_tuple[-1] == 439:
                case_str = templet_case_str439 % case_para_tuple
            else:
                pass
