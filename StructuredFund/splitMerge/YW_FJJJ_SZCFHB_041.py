...
class YW_FJJJ_SZCFHB_041(xtp_test_case):
    # YW_FJJJ_SZCFHB_041
    def test_YW_FJJJ_SZCFHB_041(self):
        title='深圳分级基金拆分合并—合并：数量最小值深圳分级基金拆分合并--合并：数量为0深圳分级基金拆分合并--合并：不符合母子基金比例'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStructuredFundInfo('161207','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
        if stkparm['返回结果'] is False:
            ...
            wt_reqs = {
                ...
                'ticker': stkparm['证券代码'],
                'side': Api.const.XTP_SIDE_TYPE['XTP_SIDE_MERGE'],
