...
class YW_FJJJ_SZCFHB_012(xtp_test_case):
    # YW_FJJJ_SZCFHB_012
    def test_YW_FJJJ_SZCFHB_012(self):
        title='深圳分级基金拆分合并—拆分：数量<最小值（min(min_divide_qty))'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStructuredFundInfo('160418','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
