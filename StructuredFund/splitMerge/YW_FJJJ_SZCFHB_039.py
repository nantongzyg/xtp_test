...
class YW_FJJJ_SZCFHB_039(xtp_test_case):
    # YW_FJJJ_SZCFHB_039
    def test_YW_FJJJ_SZCFHB_039(self):
        title='深圳分级基金拆分合并—合并：数量最小值深圳分级基金拆分合并--合并：数量为0'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStructuredFundInfo('161022','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
