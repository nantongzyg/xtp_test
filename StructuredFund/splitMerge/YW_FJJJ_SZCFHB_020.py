...
class YW_FJJJ_SZCFHB_020(xtp_test_case):
    def setUp(self):
    ...
    def test_YW_FJJJ_SZCFHB_020(self):
        title='深圳分级基金拆分合并—分拆--验资验券：无母基金持仓'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStructuredFundInfo('168201','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
        if stkparm['返回结果'] is False:
            ...
            self.assertEqual(rs['用例测试结果'], True) # 1
