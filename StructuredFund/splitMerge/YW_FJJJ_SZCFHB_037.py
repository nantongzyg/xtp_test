...
class YW_FJJJ_SZCFHB_037(xtp_test_case):
    # YW_FJJJ_SZCFHB_037
    def test_YW_FJJJ_SZCFHB_037(self):
        title='深圳分级基金拆分合并—合并：小于最小值<min_merge_qty'
        #定义当前测试用例的期待值
        ...
        case_goal = {
            '期望状态': '废单',
            'errorID': 11010126,
            'errorMSG': 'Security quantity is out of limit.',
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
        ...
        stkparm = QueryStructuredFundInfo('160217','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
