...
class YW_FJJJ_SZCFHB_049(xtp_test_case):
    # YW_FJJJ_SZCFHB_049
    def test_YW_FJJJ_SZCFHB_049(self):
        title='深圳分级基金拆分合并—合并：拆分合并状态（只允许拆分，不允许合并）'
        #定义当前测试用例的期待值
        ...
        case_goal = {
            '期望状态': '废单',
            'errorID': 11010191,
            'errorMSG': 'Invalid divide status of struct fund.',
            '是否生成报单': '是',
            '是否是撤废': '否',
            'xtp_ID': 0,
            'cancel_xtpID': 0,
        ...
        stkparm = QueryStructuredFundInfo('999999','2','26','2','0','1',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
