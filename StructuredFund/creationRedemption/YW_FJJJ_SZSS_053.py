...
class YW_FJJJ_SZSS_053(xtp_test_case):
    # YW_FJJJ_SZSS_053
    def test_YW_FJJJ_SZSS_053(self):
        title='母基金申赎—赎回：特殊无手续费的基金（160222/160224/160221）'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStructuredFundInfo('168204','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
