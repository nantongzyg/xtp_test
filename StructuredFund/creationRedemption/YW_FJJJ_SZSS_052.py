...
class YW_FJJJ_SZSS_052(xtp_test_case):

    def setUp(self):
        sql_transfer = SqlData_Transfer()
        sql_transfer.transfer_fund_asset('YW_FJJJ_SZSS_052')
        clear_data_and_restart_sz()
        Api.trade.Logout()
        Api.trade.Login()

    def test_YW_FJJJ_SZSS_052(self):
        title='母基金申赎—赎回：数量超大'
        #定义当前测试用例的期待值
        ...
        stkparm = QueryStructuredFundInfo('168203','2','26','2','0','0',case_goal['期望状态'],Api)
        # 如果下单参数获取失败，则用例失败
