...
from OptQueryFundidDB import *
from OptQueryStkassetDB import *
from OptQueryStkpriceDB import *
...
def QueryStkPriceQty(stkcode, market, security_type, security_status,
                     trade_status, call_or_put, expect_status, Api):
    global stkPriceQty
    #初始化'卖－可用数量'
    stkPriceQty['卖－可用数量'] = 0

    stkPriceQty = GetStkPriceQty(stkcode, market, security_type,
...
def GetStkPriceQty(stkcode, market, security_type, security_status,
                   trade_status, call_or_put):
    global stkPriceQty
    rs = QueryStkpriceDB(stkcode, market, security_type,
                         security_status, trade_status, call_or_put)
...
def QuerySellable_qty(Api):
    ...
    position_info = stkasset0['data']

    # if stkcode in stkasset0['data']:
