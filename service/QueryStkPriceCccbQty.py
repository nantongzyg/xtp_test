...
from QueryStkassetDB import *
from QueryStkpriceDB import *
from QueryStkpriceCccbDB import *
...
#-----入参5：cccb_flag：持仓成本校验标识，'0'为T+0,'1'为T+1
# --- 返回值：dict类型 stkparm['证券代码'],stkparm['昨收盘价'],stkparm['涨停价'],stkparm['跌停价'],stkparm['跌停价'],stkparm['随机中间价'],

def QueryStkPriceCccbQty(stkcode,market,security_type,security_status, trade_status,BSflag,cccb_flag,expect_status,Api):
    ...
    if BSflag == 'B':
        ...
        rs=QueryStkpriceCccbDB(stkcode,market,security_type,security_status, trade_status, cccb_flag, fundacc)
