...
#股票etf买卖
#买入固定费率
FEE_RATE_BUY_FIXED = 0.0001
#卖出固定费率
FEE_RATE_SELL_FIXED = 0.001
#买入特殊费率
FEE_RATE_BUY_SPECIAL = 0.0003
#卖出特殊费率
FEE_RATE_SELL_SPECIAL = 0.0003
#买入最低费用
FEE_MIN_BUY_SPECIAL = 5
#卖出最低费用
FEE_MIN_SELL_SPECIAL = 5
#买入附加费用
FEE_ADDITION_BUY_FIXED = 0.5
#卖出附加费用
FEE_ADDITION_SELL_FIXED = 0.5

#etf买卖
#买入固定费率
FEE_RATE_ETF_BUY_FIXED=0.00015
#卖出固定费率
FEE_RATE_ETF_SELL_FIXED=0.0015
#买入特殊费率
FEE_RATE_ETF_BUY_SPECIAL=0.00035
#卖出特殊费率
FEE_RATE_ETF_SELL_SPECIAL=0.00035
#买入最低费用
FEE_MIN_ETF_BUY_SPECIAL=5
#卖出最低费用
FEE_MIN_ETF_SELL_SPECIAL=5
#买入附加费用
FEE_ADDITION_ETF_BUY_FIXED=0.8
#卖出附加费用
FEE_ADDITION_ETF_SELL_FIXED=0.6
...
#自动化win 环境79
restart_path_sh = [
            'http://10.29.193.64:8080/localexec?dir=c:/xtp_test/match_sh/match_sh' + num + '&execfile=KILL_MATCH_SH' + num + '.bat',
            'http://10.29.193.64:8080/localexec?dir=c:/xtp_test/match_sh/match_sh' + num + '&execfile=MATCH_SH' + num + '.bat',
            'http://10.29.193.64:8080/localexec?dir=c:/xtp_test/xogwsh/xogwsh'+ num +'/stop&execfile=stopogwsh' + num + '.bat',
            'http://10.29.193.64:8080/localexec?dir=c:/xtp_test/xogwsh/xogwsh'+ num +'/start&execfile=startogwsh' + num + '.bat',
        ]

#执行日间委托导出 xtp_export.bat
ept_dayorderrec_sh = [
    'http://10.29.193.64:8080/localexec?dir=c:/xtp_export/bin&execfile=xtp_export.bat',
]

# 上海sqlserver 数据库服务重启
restart_sqlserver_sh = [
    'http://10.29.193.64:8080/localexec?dir=c:/sqlserver&execfile=sqlserver_stop.bat',
    'http://10.29.193.64:8080/localexec?dir=c:/sqlserver&execfile=sqlserver_start.bat',
]

stop_start_sqlserver = [
            'http://10.29.193.64:8080/localexec?dir=sqlserver&execfile=sqlserver_stop.bat',
            'http://10.29.193.64:8080/localexec?dir=sqlserver&execfile=sqlserver_start.bat',
]



sz_close = [
    'cd /home/xtp' + num + '/shell/;source /home/xtp' + num + '/.bash_profile;sh stopall.sh match',
    'cd /home/xtp' + num + '/shell/;source /home/xtp' + num + '/.bash_profile;sh stopall.sh xogwsz',
    'cd /home/xtp' + num + '/shell/;source /home/xtp' + num + '/.bash_profile;sh startall.sh match',
    'cd /home/xtp' + num + '/shell/;source /home/xtp' + num + '/.bash_profile;sh startall.sh xogwsz',
]
...
# 深圳ogw数据文件路径
ogw_data_path1 = 'cd /home/xtp' + num + '/xogwsz/data;rm -rf *' + time.strftime('%Y%m%d', time.localtime(time.time())) + '*'
ogw_data_path2 = 'cd /home/xtp' + num + '/xogwsz/bin;rm -rf xogwsz.persistence_data.' + time.strftime('%Y%m%d', time.localtime(time.time())) + '*'
