...
def QueryStkPriceQtyAva(stkcode,market,security_type,security_status, trade_status,BSflag,expect_status,Api):
        ...
        if stkcode =='999999':
            try:
                ...
                while i < len(stkcode_list):
                    ...
                    i += 1
                    if stkPriceQty['卖－可用数量'] >= min_qty and stkPriceQty['卖－可用数量'] <= max_qty:
                        break
