...
class FK_FKYW_GPWT_621(xtp_test_case):
...
#        Api.trade.Login()
    ...
    def test_FK_FKYW_GPWT_621(self):
        ...
        for i in xrange(1000):
            ...
            count = 1
            max_count = 11000
            filename1 = 'FK_FKYW_GPWT_621_order1'
            ...
            #市价五档转限 未成交、全成、部成
            wt_reqs['price_type']= Api.const.XTP_PRICE_TYPE['XTP_PRICE_BEST5_OR_LIMIT']
            count = 1
            max_count = 11000
            insert_orders(count, max_count, Api, case_goal, wt_reqs, filename1)
            time.sleep(5)
            ...
            #市价五档转撤 未成交（撤单）、全成、部撤
            wt_reqs['price_type']= Api.const.XTP_PRICE_TYPE['XTP_PRICE_BEST5_OR_CANCEL']
            count = 1
            max_count = 11000
            insert_orders(count, max_count, Api, case_goal, wt_reqs, filename1)
            time.sleep(5)
